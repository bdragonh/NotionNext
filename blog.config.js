...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '老鲍是码农', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个准点下班的普通人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.baolonghuo.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'baolonghuo, 博客', // 网站关键词 英文逗号隔开
